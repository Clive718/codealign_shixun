...
CONFIG="${CONFIG:-sft/configs/qwen3_code_qlora_predict.yaml}"
GPU_ID="${GPU_ID:-0}"
...
if [ -n "${MODEL_PATH}" ]; then
  ...
  TMP_CONFIG="$(mktemp "${PROJECT_ROOT}/sft/outputs/qwen3_code_qlora_predict/.predict_config_qlora.XXXXXX.yaml")"
